var size = 0;
var placement = 'point';
function categories_huancavelica_ccpp_3(feature, value, size, resolution, labelText,
        ...
        image: new ol.style.Circle({radius: 1.3124999999999998 + size,
...
var style_huancavelica_ccpp_3 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
...
var style = categories_huancavelica_ccpp_3(feature, value, size, resolution, labelText,
